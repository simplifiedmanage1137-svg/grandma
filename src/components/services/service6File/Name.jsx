    ...
    @media (max-width: 900px) {
        ...
        <div className="video-section">
          ...
          <div className="marquee-wrapper">
            <div className="marquee-track">
              <div className="marquee-text">BRAND IDENTITY BRAND IDENTITY BRAND IDENTITY BRAND IDENTITY</div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="top-section">
        ...
        <div className="right">
          ...
          <div className="block"><h3>Services</h3><p>Identity & Strategy</p></div>
