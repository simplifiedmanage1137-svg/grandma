  ...
  .marquee-text { font-size: 12vw; }
        ...
        <div className="video-section">
          ...
          <div className="marquee-wrapper">
            <div className="marquee-track">
              <div className="marquee-text">WEBGL DEVELOPMENT WEBGL DEVELOPMENT WEBGL DEVELOPMENT</div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="top-section">
        ...
        <div className="right">
          ...
          <div className="block"><h3>Services</h3><p>Development & Optimization</p></div>
