...
function Name() {
  ...
  return (
    ...
    .visit { margin-top: 40px; margin-left: 90px;font-size: 24px; font-weight: 900; padding-left: 60px; text-transform: uppercase; cursor: pointer; }
    .visit:hover { text-decoration: underline; }
    .right { width: 30%; padding-top: 100px; padding-left: 100px; }
    .block { margin-bottom: 50px; }
    .block h3 { font-size: 20px; font-weight: 900; text-transform: uppercase; margin: 0; }
        ...
        <div className="video-section">
          ...
          <div className="marquee-wrapper">
            <div className="marquee-track">
              <div className="marquee-text">STRATEGY BEFORE EXECUTION. STRATEGY BEFORE EXECUTION. STRATEGY BEFORE EXECUTION.</div>
            </div>
          </div>
        </div>
      </div>
