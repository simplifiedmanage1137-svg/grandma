...
function Name() {
  ...
  return (
    ...
    .visit { margin-top: 40px; font-size: 24px; font-weight: 900; padding-left: 50px; text-transform: uppercase; cursor: pointer; }
    ...
    @media (max-width: 900px) {
        ...
        <div className="video-section">
          ...
          <div className="marquee-wrapper">
            <div className="marquee-track">
              <div className="marquee-text">MOBILE APP DEVELOPMENT MOBILE APP DEVELOPMENT MOBILE APP DEVELOPMENT</div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="top-section">
        <div className="left">
          <h1>Develop high-performance mobile applications for iOS and Android that users love, with native performance and cross-platform efficiency.</h1>
          <div className="visit" onClick={() => navigate(ROUTES.CONTACT)}>Explore Mobile →</div>
        </div>
        <div className="right">
          <div className="block"><h3>Industry</h3><p>Mobile / Technology</p></div>
          <div className="block"><h3>Services</h3><p>iOS & Android Development</p></div>
